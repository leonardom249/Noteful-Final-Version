    ...
    it('should return correct notes', function () {
      ...
      return Note.findOne({userId: user.id})
        ...
        .then((res) => {
          ...
          expect(res.body).to.have.keys('id', 'title', 'userId', 'content', 'created', 'folderId', 'tags');
    ...
    it('should create and return a new item when provided valid data', function () {
      ...
      return chai.request(app)
        ...
        .then(function (_res) {
          ...
          expect(res.body).to.have.keys('id', 'userId', 'title', 'content', 'created', 'tags');
    ...
    it('should update the note', function () {
      ...
      return Note.findOne()
        ...
        .then(function (res) {
          ...
          expect(res).to.be.json;
          expect(res.body).to.be.a('object');
          expect(res.body).to.have.keys('id', 'userId', 'title', 'content', 'created', 'folderId', 'tags');
